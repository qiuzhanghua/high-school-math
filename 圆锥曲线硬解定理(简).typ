...
#template(heading2-align: left, page-footer: "第 1 页")[
  ...
  #align(center)[#text(size: 13pt, weight: "bold")[圆锥曲线硬解定理（简）——椭圆、双曲线与抛物线对照]]
  ...
  *#text(size: 12pt)[三、抛物线与直线]*

  $ y^2 = 2 p x quad "与" quad A x + B y + C = 0 $
    ...
    [
      *判别式*
      ...
      #table(
        ...
        [判别式], $Delta_x = B^2 dot Delta, quad Delta_y = Delta $,
      )
    ],
    [
      *韦达定理*
      ...
      #table(
        ...
        [$y_1 + y_2$], $(-2 p B) / A$,
        [$y_1 y_2$], $(2 p C) / A$,
        [$x_1 + x_2$], $(2 p B^2 - 2 A C) / A^2$,
        [$x_1 x_2$], $C^2 / A^2$,
        [$x_1 y_2 + x_2 y_1$], $(-2 p B C) / A^2$,
      )
    ],
  )
  ...
  #text(
    size: 10pt,
  )[*对照记忆*：① 椭圆与双曲线的判别式、韦达定理只差*符号*——把 $b^2$ 看成 $-b^2$（即把 $b^2 B^2$ 的符号反过来）即可互相转化，两张表的 $Delta_x = Delta B^2$、$Delta_y = Delta A^2$ 完全一致。② 抛物线 $y^2 = 2 p x$ 中 $x$ 是一次的，必须 $A != 0$ 才能消去 $x$，得关于 $y$ 的二次方程 $A y^2 + 2 p B y + 2 p C = 0$，故 $Delta_y = 4 p (p B^2 - 2 A C)$、$Delta_x = B^2 Delta_y$；其 $x_1 x_2 = C^2 / A^2$ 与 $p$ 无关，是抛物线特有的简洁结果。]
]
