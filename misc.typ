...
$ 1/k_(A M) + 1/k_(A H) = 2/k_(A B) = 3. quad (1) $
...
$ x_1 + x_2 = (6k(k+2))/(4 + 3k^2), quad x_1 x_2 = (3(k+2)^2 - 12)/(4 + 3k^2). quad (2) $
...
$ 1/k_(A M) + 1/k_(A N) = 1/k dot (12k)/(4) = 1/k dot 3k = 3 quad ("与" k "无关"). quad (3) $

*④ 两式相减，得 $k_(A H) = k_(A N)$。* 比较 $(1)$ 与 $(3)$：
