...
#template(heading2-align: left, page-footer: "第 1 页")[
  ...
  *【2】* 若 $f(x)$ 在 $x = 1$ 处的切线如图所示，则函数 $g(x) = x f(x)$ 在 $x = 1$ 处的切线为 #box(width: 5em, stroke: (bottom: 0.5pt))。
  ...
  *【3】* 已知函数 $f(x) = x^3 + a x^2 + 2x$ 的图象在点 $(1, f(1))$ 处的切线方程为 $y = 3x + b$，则 $a + b = $ #box(width: 5em, stroke: (bottom: 0.5pt))。
  ...
  *【4】* 若直线 $y = k x$（$k$ 为常数）与曲线 $f(x) = ln x$、曲线 $g(x) = a e^x$ 均相切，则 $a = $ #box(width: 5em, stroke: (bottom: 0.5pt))。
